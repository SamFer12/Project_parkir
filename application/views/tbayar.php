...
<body>
  ...
  <main class="container">
    <form action="<?=base_url()?>index.php/DataParkir/transaksi/<?=$data->id_kendaraan?>" method="post">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text"
          class="form-control" name="jam_keluar" id="" aria-describedby="jam_keluar" placeholder="" value="<?=date('Y-m-d H:i:s')?>">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        <label for="" class="form-label">Uang Customer</label>
        <input type="text"
          class="form-control" name="uang_customer" id="" aria-describedby="uang_customer" placeholder="" value="">
