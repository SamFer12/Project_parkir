  ...
  <header>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark " style="background-color: #191970;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            ...
            <form class="d-flex my-2 my-lg-0" action="<?=base_url()?>index.php/DataAdmin" method="GET">
                <input class="form-control me-sm-2" type="text" placeholder="Search Data Admin" name="query">
