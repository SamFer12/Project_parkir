  ...
  <main class="container">
    <form action="<?=base_url()?>index.php/DataCustomer/edit_proses/<?=$data->id_member?>" method="post">
      <div class="mb-3">
        ...
        <label for="" class="form-label">Jenis_kendaraan</label>
        <input type="text"
          class="form-control" name="plat_nomor" id="" aria-describedby="plat_nomor" placeholder="" value="<?=$data->no_pol?>">
          <input type="text"
          class="form-control" name="Jenis_kendaraan" id="" aria-describedby="Jenis_kendaraan" placeholder="" value="<?=$data->nm_kategori?>">
      </div>
