            ...
            <table class="table table-primary">
                <thead>
                    <tr>
                        ...
                        <th scope="col">harga 1jam</th>
                        
                        <th scope="col">
                            <a name="" id="" class="btn btn-primary" href="<?=base_url()?>index.php/Kategori/tambah" role="button">Tambah data</a>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td><?=$value->harga_1jam?></td> 
                        <td>
                            <a name="" id="" class="btn btn-primary" href="<?=base_url()?>index.php/kategoriedit/<?=$value->nm_kategori?>" role="button">Edit</a>
                            <a name="" id="" class="btn btn-danger" href="<?=base_url()?>index.php/kategorihapus/<?=$value->harga_1jam?>" role="button">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
